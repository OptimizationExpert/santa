# -*- coding: utf-8 -*-
"""final of Hill Climbing Project .ipynb

Automatically generated by Colab.

Original file is located at
https://colab.research.google.com/drive/1lw7FcvS-E4f-shFfjf4nS_y1fU2zTiO6?usp=sharing
# Data
"""
...
def create_next_generation_via_loval_search(population, values):
    crossover_prob = 0.7
    new_population = []
...
def create_next_generation_via_perturb_local(population, values, prob):
    mutation_prob =prob
    new_population = []
    working_pop = copy.deepcopy(population)
    while len(new_population) < 0.5 * len(population):
...
itermax = 2000
for counter in range(itermax):
    pr = min(1,0.5-0.5*counter/itermax)
    pop3 = create_next_generation_via_perturb_local(population, values, pr)
...
for idx, row in df.iterrows():
    ax.barh(row['Activity'], row['Duration'], left=row['Start'], color='orange', edgecolor='black')
